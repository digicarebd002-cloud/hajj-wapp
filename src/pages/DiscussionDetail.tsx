      ...
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="bg-card rounded-xl card-shadow p-5">
          ...
          {!user ? (
            ...
            <>
              <Textarea value={replyText} onChange={(e) => setReplyText(e.target.value)} placeholder="Write your reply..." className="resize-none min-h-[100px] mb-1" />
              <div className="flex items-center justify-end">
                <Button onClick={handleReply} disabled={replyText.trim().length < 1 || posting}>{posting ? "Posting..." : "Post Reply"}</Button>
              </div>
            </>
          )}
        </div>
